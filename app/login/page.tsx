        ...
        <div className="rounded-3xl border border-slate-200 dark:border-white/10 bg-slate-50/80 dark:bg-white/5 backdrop-blur-2xl p-6 sm:p-8 shadow-xl dark:shadow-2xl">
          {submitted ? (
            <div className="text-center py-8 space-y-4">
              ...
              <h2 className="text-2xl font-black text-slate-900 dark:text-white">Login Request Sent!</h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  <label className="block text-xs font-semibold text-slate-700 dark:text-gray-300 mb-1.5">
                    Email or Username <span className="text-cyan-600 dark:text-cyan-400">*</span>
                  </label>
