        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="hidden md:flex items-center gap-3 shrink-0">
            ...
            <a
              ...
              className="group relative inline-flex items-center gap-1.5 px-3 py-2 text-xs font-bold rounded-xl border border-emerald-500/40 bg-emerald-500/10 hover:bg-emerald-500/20 text-emerald-600 dark:text-emerald-400 hover:text-emerald-700 dark:hover:text-emerald-300 transition-all duration-300 shadow-md hover:shadow-emerald-500/20 hover:-translate-y-0.5 active:translate-y-0 cursor-pointer"
          ...
          <div className="lg:hidden mt-4 bg-slate-50/95 dark:bg-slate-900/95 border border-slate-200 dark:border-white/10 rounded-2xl p-4 backdrop-blur-2xl shadow-2xl space-y-2 text-slate-800 dark:text-white transition-colors duration-300">
            ...
            <div className="flex gap-2 mt-3 w-full">
              <a
                href="/resume/resume.pdf"
                download
                className="flex flex-1 items-center justify-center gap-2 py-2.5 rounded-xl bg-cyan-500/10 border border-cyan-500/30 text-cyan-700 dark:text-cyan-300 text-sm font-bold shadow-xs hover:bg-cyan-500/20 transition-all"
              >
                <Download size={16} />
                <span>Resume</span>
              </a>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center p-2.5 rounded-xl bg-emerald-500/10 border border-emerald-500/30 text-emerald-600 dark:text-emerald-400 hover:bg-emerald-500/20 transition-all"
                aria-label="Contact on WhatsApp"
              >
